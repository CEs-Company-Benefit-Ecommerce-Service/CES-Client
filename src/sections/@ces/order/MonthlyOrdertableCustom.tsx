...
MonthlyOrderTableCustom.getLayout = function getLayout(page: React.ReactElement) {
  return <Layout>{page}</Layout>
}

export default function MonthlyOrderTableCustom() {
  const {
    dense,
    page,
    order,
  ...
  const { data: orders, isLoading } = useOrderByCompanyId({
